...
`vagrant up` to install the environment. Note that it will take a quuite amount of time and you have to run this command everytime you reboot your system. Then run `vagrant ssh`from the same directory to log in to the Virtual Environment.
